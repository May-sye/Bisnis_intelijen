-- Active: 1727311254060@@127.0.0.1@3306@tugasbi
-- Active: 1727311254060@@127.0.0.1@3306@tugasbi
...
INSERT INTO nelayan (id_nelayan, nama_nelayan, alamat)
VALUES
...
VALUES 
    ...
    (5020, 7, 7, 307, 230),
    (5021, 8, 8, 308, 400);
INSERT INTO pendaratan_ikan (id_pendaratan, id_pelabuhan, id_tangkapan, tanggal_pendaratan) 
VALUES 
...
VALUES 
    ...
    (9, 9, 9, 32000),
    (10, 10, 10, 70000);
ALTER TABLE pembeli_ikan
ADD id_penjual INT(11);
ALTER TABLE pembeli_ikan
ADD CONSTRAINT FK_pembeli_ikan_penjual_ikan
FOREIGN KEY (id_penjual) REFERENCES penjual_ikan(id_penjual);
